...
*/
	...
	var $database = 'jbdpqh_roo';			/// Name of database to be used.	
	var $host = 'localhost'; 			/// The hostname of the database server	
	var $user = 'jbdpqh_sn00p'; 			/// The username which is used to connect to the database server. 
	var $password = 'tr0u8L3'; 		/// Password for the username. For security, we no longer store it.
